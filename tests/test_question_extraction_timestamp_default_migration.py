...
MIGRATION_PATH = (
    ...
    / "alembic"
    / "versions"
    / "c4e6a8b0d213_add_question_extraction_run_timestamp_defaults.py"
)

SPEC = importlib.util.spec_from_file_location(
    "question_extraction_run_timestamp_default_migration",
    MIGRATION_PATH,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(
        "Question Extraction Run timestamp-default migration could not be loaded."
    )
...
class QuestionExtractionRunTimestampDefaultMigrationTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_upgrade_adds_only_required_timestamp_defaults(self) -> None:
        ...
        self.assertEqual(MIGRATION.revision, "c4e6a8b0d213")
        self.assertEqual(MIGRATION.down_revision, "9b5165810c21")
        ...
        self.assertEqual(
            ...
            [
                ("question_extraction_runs", "created_at"),
                ("question_extraction_runs", "updated_at"),
            ],
        )
        for call in calls:
